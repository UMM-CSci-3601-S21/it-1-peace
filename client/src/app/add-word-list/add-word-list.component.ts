...
export class AddWordListComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private userService: WordListService, private snackBar: MatSnackBar, private router: Router) {
  }
  ...
  submitForm() {
    this.userService.addWordList(this.addWordListForm.value).subscribe(newID => {
